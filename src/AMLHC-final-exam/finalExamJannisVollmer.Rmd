...
Examining the statistics by class:
...
- **Class CL**: Sensitivity is 0%, indicating the model failed to identify any patients correctly as CL. Specificity is 100%, reflecting perfect true negative predictions, but the PPV is not applicable (NaN), and the NPV is 94.44%.
