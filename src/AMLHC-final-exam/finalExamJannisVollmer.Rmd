...
rf_model
```
The 'rf_model' shows that the accuracy is the highest, when using the mtry=2. This means that at each split in the tree, 2 predictors are randomly chosen from the total set of predictors (17 in this case), and the best split among those 2 is used to partition the data.

### Get Feature importance and show it
